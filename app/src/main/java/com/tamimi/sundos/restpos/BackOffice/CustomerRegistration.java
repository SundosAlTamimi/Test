...
public class CustomerRegistration extends AppCompatActivity {
    ...
    EditText customerName,customerCode,memberShipCardNo,streetNoName,city
            , phoneNo,MobileNo,NameShow,birthday,anniversary,occupation,email,totalPoint,redeemedPoint,remaining,remark;
    RadioGroup conder;
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        final ArrayList<String> coenderList = new ArrayList<>();
            ...
            public void onClick(View v) {
                ...
                if (!customerNameList.isEmpty()) {
                    for (int i = 0; i < customerNameList.size(); i++) {
                        ...
                        customerRegistrationModel.setCoender(coenderList.get(i));
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!customerName.getText().toString().equals("") && !customerCode.getText().toString().equals("") && !MobileNo.getText().toString().equals("") && !phoneNo.getText().toString().equals("") && !city.getText().toString().equals("") && !memberShipCardNo.getText().toString().equals("") &&
                        !streetNoName.getText().toString().equals("") && !NameShow.getText().toString().equals("")&&!birthday.getText().toString().equals("") &&!anniversary.getText().toString().equals("") &&!occupation.getText().toString().equals("") &&!email.getText().toString().equals("") &&!totalPoint.getText().toString().equals("") &&
                        !redeemedPoint.getText().toString().equals("") &&!remaining.getText().toString().equals("") ) {
                    ...
                    if(mal.isChecked()){coenderList.add("male");
                    Log.e("+++","male");}
                    else{coenderList.add("female");
                        Log.e("+++","female");}

                    Toast.makeText(CustomerRegistration.this, "OK", Toast.LENGTH_SHORT).show();

                    customerName.setText("");
                    customerCode.setText("");MobileNo.setText("");
                    phoneNo.setText("");
                    city.setText("");
...
void initialize()
{
    ...
    conder=(RadioGroup)findViewById(R.id.radio_mal_female);
